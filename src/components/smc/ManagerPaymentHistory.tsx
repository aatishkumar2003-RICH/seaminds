          ...
          <div style={{ maxWidth: "720px", margin: "0 auto", padding: "24px 16px" }}>
            ...
            <button
              onClick={async () => {
                ...
                // Add footer with page numbers and disclaimer to all pages
                ...
                for (let p = 1; p <= totalPages; p++) {
                  ...
                  doc.text("CONFIDENTIAL — This document contains proprietary assessment data. Unauthorised distribution is prohibited.", 15, pageH - 13);
                  doc.text("Generated by SeaMinds · Maritime Intelligence Platform", 15, pageH - 9);
                  doc.setFont("helvetica", "bold");
                  doc.setTextColor(212, 175, 55);
                  doc.text(`Page ${p} of ${totalPages}`, w - 15, pageH - 9, { align: "right" });
                }
