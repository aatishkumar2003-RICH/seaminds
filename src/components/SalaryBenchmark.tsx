...
const SALARY_DATA: Record<string, SalaryRange> = {
  "Captain|Container": { min: 7500, max: 14200 },
  "Captain|Tanker (Crude)": { min: 8000, max: 16500 },
  "Captain|Tanker (Chemical)": { min: 7500, max: 15000 },
  "Captain|LNG": { min: 10000, max: 21000 },
  "Captain|LPG": { min: 9000, max: 18000 },
  "Captain|Bulk Carrier": { min: 7000, max: 13500 },
  "Captain|General Cargo": { min: 6500, max: 12800 },
  "Captain|Car Carrier": { min: 7500, max: 14200 },
  "Captain|Offshore": { min: 9000, max: 19500 },
  "Captain|Cruise": { min: 8500, max: 18000 },
  "Chief Officer|Container": { min: 4500, max: 9800 },
  "Chief Officer|Tanker (Crude)": { min: 5000, max: 10500 },
  "Chief Officer|Tanker (Chemical)": { min: 4800, max: 10200 },
  "Chief Officer|LNG": { min: 6000, max: 12800 },
  "Chief Officer|Bulk Carrier": { min: 4200, max: 9000 },
  "Chief Officer|General Cargo": { min: 4000, max: 8200 },
  "Chief Officer|LPG": { min: 5500, max: 11200 },
  "Chief Officer|Car Carrier": { min: 4500, max: 9800 },
  "Chief Officer|Offshore": { min: 5500, max: 12000 },
  "Chief Officer|Cruise": { min: 5000, max: 10500 },
  "2nd Officer|Container": { min: 3200, max: 6800 },
  "2nd Officer|Tanker (Crude)": { min: 3500, max: 7200 },
  "2nd Officer|Tanker (Chemical)": { min: 3300, max: 6900 },
  "2nd Officer|LNG": { min: 4000, max: 8200 },
  "2nd Officer|Bulk Carrier": { min: 3000, max: 6200 },
  "2nd Officer|General Cargo": { min: 2800, max: 6000 },
  "2nd Officer|LPG": { min: 3500, max: 7500 },
  "2nd Officer|Car Carrier": { min: 3200, max: 6800 },
  "2nd Officer|Offshore": { min: 3800, max: 7800 },
  "2nd Officer|Cruise": { min: 3400, max: 7200 },
  "3rd Officer|Container": { min: 2500, max: 5200 },
  "3rd Officer|Tanker (Crude)": { min: 2700, max: 5800 },
  "3rd Officer|Tanker (Chemical)": { min: 2600, max: 5400 },
  "3rd Officer|LNG": { min: 3000, max: 6200 },
  "3rd Officer|Bulk Carrier": { min: 2300, max: 4800 },
  "3rd Officer|General Cargo": { min: 2200, max: 4500 },
  "3rd Officer|LPG": { min: 2800, max: 5800 },
  "3rd Officer|Car Carrier": { min: 2500, max: 5200 },
  "3rd Officer|Offshore": { min: 2800, max: 6000 },
  "3rd Officer|Cruise": { min: 2600, max: 5400 },
  "Chief Engineer|Container": { min: 6500, max: 12800 },
  "Chief Engineer|Tanker (Crude)": { min: 7000, max: 15000 },
  "Chief Engineer|Tanker (Chemical)": { min: 6800, max: 14200 },
  "Chief Engineer|LNG": { min: 9000, max: 19500 },
  "Chief Engineer|Bulk Carrier": { min: 6000, max: 12000 },
  "Chief Engineer|General Cargo": { min: 5500, max: 11200 },
  "Chief Engineer|LPG": { min: 8000, max: 16500 },
  "Chief Engineer|Car Carrier": { min: 6500, max: 12800 },
  "Chief Engineer|Offshore": { min: 8500, max: 18000 },
  "Chief Engineer|Cruise": { min: 7500, max: 15000 },
  "2nd Engineer|Container": { min: 4000, max: 8200 },
  "2nd Engineer|Tanker (Crude)": { min: 4500, max: 9000 },
  "2nd Engineer|Tanker (Chemical)": { min: 4200, max: 8800 },
  "2nd Engineer|LNG": { min: 5500, max: 11200 },
  "2nd Engineer|Bulk Carrier": { min: 3800, max: 7800 },
  "2nd Engineer|General Cargo": { min: 3500, max: 7500 },
  "2nd Engineer|LPG": { min: 5000, max: 10500 },
  "2nd Engineer|Car Carrier": { min: 4000, max: 8200 },
  "2nd Engineer|Offshore": { min: 5000, max: 10500 },
  "2nd Engineer|Cruise": { min: 4500, max: 9000 },
  "3rd Engineer|Container": { min: 2800, max: 5800 },
  "3rd Engineer|Tanker (Crude)": { min: 3000, max: 6200 },
  "3rd Engineer|Tanker (Chemical)": { min: 2900, max: 6000 },
  "3rd Engineer|LNG": { min: 3500, max: 7500 },
  "3rd Engineer|Bulk Carrier": { min: 2600, max: 5400 },
  "3rd Engineer|General Cargo": { min: 2400, max: 5100 },
  "3rd Engineer|LPG": { min: 3200, max: 6800 },
  "3rd Engineer|Car Carrier": { min: 2800, max: 5800 },
  "3rd Engineer|Offshore": { min: 3200, max: 6800 },
  "3rd Engineer|Cruise": { min: 3000, max: 6000 },
  "ETO|Container": { min: 3500, max: 7500 },
  "ETO|Tanker (Crude)": { min: 3800, max: 8200 },
  "ETO|Tanker (Chemical)": { min: 3600, max: 7800 },
  "ETO|LNG": { min: 4500, max: 9800 },
  "ETO|Bulk Carrier": { min: 3200, max: 6800 },
  "ETO|General Cargo": { min: 3000, max: 6200 },
  "ETO|LPG": { min: 4000, max: 8800 },
  "ETO|Car Carrier": { min: 3500, max: 7500 },
  "ETO|Offshore": { min: 4000, max: 9000 },
  "ETO|Cruise": { min: 3800, max: 8200 },
  "Bosun|Container": { min: 1800, max: 3600 },
  "Bosun|Tanker (Crude)": { min: 2000, max: 4000 },
  "Bosun|Tanker (Chemical)": { min: 1900, max: 3100 },
  "Bosun|LNG": { min: 2200, max: 4500 },
  "Bosun|Bulk Carrier": { min: 1700, max: 2800 },
  "Bosun|General Cargo": { min: 1600, max: 2600 },
  "Bosun|LPG": { min: 2000, max: 3400 },
  "Bosun|Car Carrier": { min: 1800, max: 3600 },
  "Bosun|Offshore": { min: 2200, max: 4500 },
  "Bosun|Cruise": { min: 2000, max: 4000 },
  "AB|Container": { min: 1400, max: 2200 },
  "AB|Tanker (Crude)": { min: 1500, max: 2400 },
  "AB|Tanker (Chemical)": { min: 1450, max: 2300 },
  "AB|LNG": { min: 1800, max: 3600 },
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="rounded-xl p-3" style={{ background: "rgba(13,27,42,0.6)", border: "1px solid rgba(255,255,255,0.05)" }}>
            <p className="text-[10px] text-muted-foreground text-center leading-tight">
              Based on vacancies posted on SeaMinds — indicative only. Salary ranges are indicative and based on published ITF/BIMCO 2026 scales. Actual offers vary by company, flag state, and experience.
            </p>
          </div>
        </div>
      </div>
